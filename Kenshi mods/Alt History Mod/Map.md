...
```leaflet  
id: KenshiMap ### Must be unique with no spaces  
image: [[Pasted image 20251008024640.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [4096, 4096]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
